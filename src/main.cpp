...
engine::Fifo fifo;
   ...
   std::thread th1(&engine::Fifo::read,&fifo,std::ref(state_game));
    ...
    ///////Gestion de l'entrée du joueur sur le serveur
    Json::Value data;
            
    sf::Http::Request request_condi;
     request_condi.setMethod(sf::Http::Request::Get);
     request_condi.setUri("/user/1");
     sf::Http http("http://localhost",8080);
     sf::Http::Response response_condi = http.sendRequest(request_condi);
     
     if(response_condi.getStatus()==200)
         data["ID"]=2;
     else data["ID"]=1;
     ...
     sf::Http::Request request_condi2;
     request_condi2.setMethod(sf::Http::Request::Get);
     request_condi2.setUri("/user/1");
     
     sf::Http::Response response_condi2 = http.sendRequest(request_condi2);
     std::cout<<response_condi2.getBody()<<std::endl;
